...
MODALITY_INFO = {
    ...
    "tok_segmap": {
        ...
        "patch_size": 8,
        "vocab_size": 1,
        "data_dim": 1,  # TODO (JEFF): check!
        "modality_type": "segmap",
        "encoder_embedding": partial(
            ContinuousImageTokenEncoderEmbedding,
            flow="rf",
            data_dim=1,
    ...
    "tok_ebv": {
        ...
        "vocab_size": 1,
        "data_dim": 1,
        "modality_type": "ebv",  # probably not same as extinction?
        "encoder_embedding": partial(
            ContinuousImageTokenEncoderEmbedding,
            flow="rf",
            data_dim=1,
    ...
    "tok_pmra": {
        ...
        "max_tokens": 1,
        "type": "img",
        "id": generate_uint15_hash("tok_pmra"),
        "pretokenized": True,
    },
    "tok_pmdec": {
        "input_size": 1,
        ...
        "max_tokens": 1,
        "type": "img",
        "id": generate_uint15_hash("tok_pmdec"),
        "pretokenized": True,
    },
}
