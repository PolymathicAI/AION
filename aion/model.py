...
class AION(FM):
    ...
    def parent_forward(self, mod_dict: Dict[str, Dict[str, torch.Tensor]], num_encoder_tokens: int, num_decoder_tokens: int, loss_type: str = 'mod', return_logits: bool = False):
        return super().forward(mod_dict, num_encoder_tokens, num_decoder_tokens, loss_type, return_logits)
